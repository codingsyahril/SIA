...
<div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="GET" action="update/update_keluar.php">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Penerima</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Penanggung Jawab" name="penerima" value="<?php echo $e['penerima'];?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Saldo Masuk" name="keluar" value="<?php echo $e['keluar'];?>">
                  </div>
                  <div class="form-group">
